"""
Starter fabfile for deploying the djangobasetemplate project.
...
# CHANGEME
env.hosts = ['user@djangobasetemplate.example.com']
env.code_dir = '/srv/www/djangobasetemplate'
env.project_dir = '/srv/www/djangobasetemplate/djangobasetemplate'
env.static_root = '/srv/www/djangobasetemplate/static/'
env.virtualenv = '/srv/www/djangobasetemplate/.virtualenv'
env.code_repo = 'git@github.com:user/djangobasetemplate.git'
env.django_settings_module = 'djangobasetemplate.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/djangobasetemplate/wsgi.py" % env.code_dir)
