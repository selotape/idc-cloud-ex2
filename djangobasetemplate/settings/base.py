...
ROOT_URLCONF = 'djangobasetemplate.urls'
...
DEBUG_TOOLBAR_CONFIG = {
    ...
    'SHOW_TOOLBAR_CALLBACK': 'djangobasetemplate.settings.base.custom_show_toolbar',
...
WSGI_APPLICATION = 'djangobasetemplate.wsgi.application'
...
SYSTEM_EMAIL_PREFIX = "[djangobasetemplate]"

## Log settings

LOG_LEVEL = logging.INFO
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_djangobasetemplate"  # Make this unique to your project.
...
#CEF_PRODUCT = 'djangobasetemplate'
